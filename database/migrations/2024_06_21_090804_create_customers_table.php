...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('customers', function (Blueprint $table) {
            ...
            $table->boolean('oral_suggestion')->default(false);
            $table->boolean('ricardo_suggestion')->default(false);
            $table->boolean('socialmedia_suggestion')->default(false);
            $table->boolean('flyer_suggestion')->default(false);
